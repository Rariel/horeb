    ...
    <div id="wrapper">
        ...
        <div class="container_12">
            ...
            <div class="grid_12">
                ...
                <a href="<?php print url('node/3'); ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'bluemasters') . '/images/ejecutivos_trabajando-crop-u672.jpg'; ?>"></a>
                </div>
                <div class="slider-item-caption"></div>
                </li>
                <!-- EOF: slider-item -->
                ...
                <li class="slider-item">
                <div class="slider-item-image">
                <a href="<?php print url('node/2'); ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'bluemasters') . '/images/diagnostico-crop-u686.jpg'; ?>"></a>
                </div>
                <div class="slider-item-caption"></div>
                </li>
                <!-- EOF: slider-item -->
                ...
                <li class="slider-item">
                <div class="slider-item-image">
                <a href="<?php print url('node/1'); ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'bluemasters') . '/images/imagen12-compressor1.jpg'; ?>"></a>
                </div>
                <div class="slider-item-caption"></div>
                </li>
                <!-- EOF: slider-item -->
